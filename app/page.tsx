...
// Маппинг: id проекта → компонент
const interactiveComponents: Record<string, React.ComponentType> = {
    "water-treatment": InteractiveScada,   // ID первого проекта (водоочистка)
    "boiler-house": InteractiveScadaKotel, // ID второго проекта (котельная)
};
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {projects.map((project) => {
                        const InteractiveComponent = interactiveComponents[project.id];
                        ...
                        return (
                            ...
                            >
                                <div className="relative bg-gray-100 dark:bg-gray-700 overflow-hidden">
                                    ...
                                    {/* Бейдж сложности (показываем поверх всего с z-10) - ОСТАВЛЕН ТОЛЬКО ОДИН РАЗ */}
                                    <div className="absolute top-4 right-4 z-10">
                                        <span className={`px-3 py-1 text-xs font-semibold rounded-full shadow-sm backdrop-blur-sm ${project.complexity === 'advanced'
