...
export default function InteractiveScada() {
  ...
  return (
    <div className="w-full bg-[#0a2540] p-3 rounded-lg">
      {/* Верхняя панель: только Режим и Кнопки */}
        ...
        <>
          ...
          <div className="relative w-full mb-2" style={{ height: '360px' }}>
            ...
            >
              ...
              {/* От бака-реактора вниз к насосам */}
              <path d="M 170 320 L 170 380 L 220 380" stroke="#00b4d8" strokeWidth="6" fill="none" opacity="0.8"/>
              <path d="M 170 320 L 170 380 L 300 380" stroke="#00b4d8" strokeWidth="6" fill="none" opacity="0.8"/>
              
              {/* От насосов вниз и вправо к нижней горизонтали */}
              <path d="M 220 420 L 220 460 L 400 460" stroke="#00b4d8" strokeWidth="6" fill="none" opacity="0.8"/>
              ...
              {/* От нижней горизонтали к насосу справа */}
              <path d="M 1050 420 L 1050 460 L 1100 460" stroke="#00b4d8" strokeWidth="6" fill="none" opacity="0.8"/>
              
              {/* От насоса справа вверх к РПВ */}
              <path d="M 1100 460 L 1100 350 L 1050 350" stroke="#00b4d8" strokeWidth="6" fill="none" opacity="0.8"/>
              ...
              <g onClick={() => togglePump(1)} className="cursor-pointer">
                <rect x="200" y="380" width="40" height="40" rx="5" fill="#606060" stroke="#404040" strokeWidth="2"/>
                {/* Анимированная крыльчатка */}
                {pump1Running && (
                  <g className="animate-spin" style={{ transformOrigin: '220px 400px' }}>
                    <path d="M 220 388 L 228 400 L 220 412 L 212 400 Z" fill="#00b4d8"/>
                  </g>
                )}
                <circle cx="220" cy="400" r="8" fill={pump1Running ? '#00b4d8' : '#404040'}/>
                <text x="220" y="440" textAnchor="middle" fontSize="10" fill="white">Насос 1</text>
                {/* Индикатор статуса */}
                <rect x="245" y="385" width="50" height="20" rx="3" fill={pump1Running ? '#2d5016' : '#8b0000'}/>
                <text x="270" y="399" textAnchor="middle" fontSize="10" fontWeight="bold" fill="white">
              ...
              {/* ===== РЧВ1 (внутри SVG, соединён трубой) ===== */}
              <g>
              ...
              {/* ===== РЧВ2 (внутри SVG, соединён трубой) ===== */}
              <g>
              ...
              {/* ===== РПВ (внутри SVG, соединён трубой) ===== */}
              <g>
                ...
                <g>
                  <circle cx="1070" cy="360" r="5" fill={pump1Running ? '#00ff00' : '#ff0000'}/>
                  <circle cx="1090" cy="360" r="5" fill={pump2Running ? '#00ff00' : '#ff0000'}/>
                  <circle cx="1110" cy="360" r="5" fill={pumpMainRunning ? '#00ff00' : '#ff0000'}/>
                </g>
                <text x="1100" y="375" textAnchor="middle" fontSize="9" fill="white">ВУ СУ НУ</text>
              </g>
